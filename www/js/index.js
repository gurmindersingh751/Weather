...
function getweather() {
    if (navigator.geolocation) {
        ...
        navigator.geolocation.getCurrentPosition(function(position) {
                ...
                var weatherURL = "http://api.openweathermap.org/data/2.5/weather? lat=" + lat + "&lon =" + lon + " &APPID=598f2236859a359ebfe7fdd7fd8f5cc8";
...
function getWeather(latitude, longitude) {
    ...
    var OpenWeatherAppKey = "598f2236859a359ebfe7fdd7fd8f5cc8";
